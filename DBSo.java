 ...
 * @author Tsz-Chiu Au
 */
public class DBSo extends Strategy {
    private final static String _abbrName = "DBSo";
    private final static String _name = "Derivative Belief Strategy (version o)" ;
    ...
    private final static int violationTolerance = 12 ;
