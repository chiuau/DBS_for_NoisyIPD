 ...
 * @author Tsz-Chiu Au
 */
public class DBSm extends Strategy {
    private final static String _abbrName = "DBSa";
    private final static String _name = "Derivative Belief Strategy (version m)" ;
    ...
    private final static int violationTolerance = 8 ;
