 ...
 * @author Tsz-Chiu Au
 */
public class DBSz extends Strategy {
    private final static String _abbrName = "DBSz";
    private final static String _name = "DBS (version z)" ;
    ...
    private final static int reuseViolationThreshold = 12 ;
