...
/**
 * Derivative Belief Strategy (with learning prevention)
 * @author Tsz-Chiu Au
 */
public class DBSpl extends Strategy {
    private final static String _abbrName = "DBSpl";
    private final static String _name = "DBS with learning prevention" ;
