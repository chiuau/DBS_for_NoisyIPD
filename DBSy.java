 ...
 * @author Tsz-Chiu Au
 */
public class DBSy extends Strategy {
    private final static String _abbrName = "DBSy";
    private final static String _name = "DBS (version y)" ;
    ...
    private final static int reuseViolationThreshold = 10 ;
