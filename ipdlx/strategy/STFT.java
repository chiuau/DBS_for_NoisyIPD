...
public class STFT extends Strategy {
    private final static String _abbrName = "STFT";
    private final static String _name = "Suspicious TFT";
    private final static String _description = "Like TFT but starts with DEFECTION.";

    public STFT() {
        super(_abbrName, _name, _description);
    }

    protected STFT(String abbrName, String name, String description) {
